...
# Whitening (9-bit LFSR, described in section 6.2.3.4 "Whitening" of the SX1262 datasheet)
# Although some sources imply the actual algorithm is different, so verify this.
