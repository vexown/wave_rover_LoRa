 ...
 * For SDA and SCL GPIO number confirmation see the schematics of the Heltec V3.1 board 
...
#define I2C_MANAGER_DEFAULT_SDA GPIO_NUM_17 // Default SDA pin
#define I2C_MANAGER_DEFAULT_SCL GPIO_NUM_18 // Default SCL pin
